...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Terminal Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link hu.textualmodeler.ast.impl.TerminalNodeImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link hu.textualmodeler.ast.impl.TerminalNodeImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TerminalNodeImpl extends VisibleNodeImpl implements TerminalNode {
	/**
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.TERMINAL_NODE;
	}
	...
	public void setContent(String newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.TERMINAL_NODE__CONTENT, oldContent, content));
	}
