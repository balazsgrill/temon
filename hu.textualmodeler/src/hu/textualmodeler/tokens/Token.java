 ...
 *   <li>{@link hu.textualmodeler.tokens.Token#getStart <em>Start</em>}</li>
 *   <li>{@link hu.textualmodeler.tokens.Token#getLength <em>Length</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Token extends EObject {
	 ...
	 * @see #setStart(int)
	 * @see hu.textualmodeler.tokens.TokensPackage#getToken_Start()
	 * @model
	 * @generated
	 */
	int getStart();
	...
	/**
	 * Sets the value of the '{@link hu.textualmodeler.tokens.Token#getStart <em>Start</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLength(int)
	 * @see hu.textualmodeler.tokens.TokensPackage#getToken_Length()
	 * @model
	 * @generated
	 */
	int getLength();
	...
	/**
	 * Sets the value of the '{@link hu.textualmodeler.tokens.Token#getLength <em>Length</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
