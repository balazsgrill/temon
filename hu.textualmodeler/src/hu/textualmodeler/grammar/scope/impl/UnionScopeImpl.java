...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Union Scope</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link hu.textualmodeler.grammar.scope.impl.UnionScopeImpl#getSubScopes <em>Sub Scopes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UnionScopeImpl extends ScopeImpl implements UnionScope {
	/**
	...
	protected EClass eStaticClass() {
		return ScopePackage.Literals.UNION_SCOPE;
	}
	...
	public EList<Scope> getSubScopes() {
		if (subScopes == null) {
			subScopes = new EObjectContainmentEList<Scope>(Scope.class, this, ScopePackage.UNION_SCOPE__SUB_SCOPES);
		}
		return subScopes;
	}
