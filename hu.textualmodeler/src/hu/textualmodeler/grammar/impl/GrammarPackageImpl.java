...
public class GrammarPackageImpl extends EPackageImpl implements GrammarPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTerminal_Priority(), ecorePackage.getEInt(), "priority", "0", 0, 1, Terminal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
