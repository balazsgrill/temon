 ...
 * <ul>
 *   <li>{@link hu.temon.grammar.impl.NonTerminalItemImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link hu.temon.grammar.impl.NonTerminalItemImpl#getNonTerminal <em>Non Terminal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonTerminalItemImpl extends SyntaxItemImpl implements NonTerminalItem {
	...
	protected EClass eStaticClass() {
		return GrammarPackage.Literals.NON_TERMINAL_ITEM;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrammarPackage.NON_TERMINAL_ITEM__FEATURE_NAME, oldFeatureName, featureName));
	}
	...
	public void setNonTerminal(String newNonTerminal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrammarPackage.NON_TERMINAL_ITEM__NON_TERMINAL, oldNonTerminal, nonTerminal));
	}
