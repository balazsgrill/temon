...
/**
 * Pattern-specific match representation of the hu.textualmodeler.query.infix.E2 pattern, 
 * to be used in conjunction with {@link E2Matcher}.
 * 
...
public abstract class E2Match extends BasePatternMatch {
  ...
  private E2Match(final Token pFirst, final Token pNext) {
    this.fFirst = pFirst;
    this.fNext = pNext;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof E2Match)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return E2Matcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends E2Match {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends E2Match {
