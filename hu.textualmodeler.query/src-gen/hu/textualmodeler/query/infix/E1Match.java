...
/**
 * Pattern-specific match representation of the hu.textualmodeler.query.infix.E1 pattern, 
 * to be used in conjunction with {@link E1Matcher}.
 * 
...
public abstract class E1Match extends BasePatternMatch {
  ...
  private E1Match(final Token pFirst, final Token pNext) {
    this.fFirst = pFirst;
    this.fNext = pNext;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof E1Match)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return E1Matcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends E1Match {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends E1Match {
