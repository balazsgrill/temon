...
/**
 * This is the item provider adapter for a {@link hu.textualmodeler.grammar.Push} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PushItemProvider
	...
	protected void addFeatureNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Push_featureName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Push_featureName_feature", "_UI_Push_type"),
				 GrammarPackage.Literals.PUSH__FEATURE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Push)object).getFeatureName();
