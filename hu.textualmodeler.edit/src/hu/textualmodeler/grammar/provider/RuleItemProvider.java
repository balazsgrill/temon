...
/**
 * This is the item provider adapter for a {@link hu.textualmodeler.grammar.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrammarPackage.Literals.RULE__BODY);
		}
	...
	public String getText(Object object) {
		String label = ((Rule)object).getNonTerminal();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__BODY,
				 GrammarFactory.eINSTANCE.createTerminalItem()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__BODY,
				 GrammarFactory.eINSTANCE.createNonTerminalItem()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__BODY,
				 GrammarFactory.eINSTANCE.createSetValue()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__BODY,
				 GrammarFactory.eINSTANCE.createPush()));

		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.RULE__BODY,
				 GrammarFactory.eINSTANCE.createPop()));
	}
